				...
				if ( 1 == get_theme_mod( 'colormag_home_icon_display', 0 ) ) {
					...
					<div class="<?php echo esc_attr( $home_icon_class ); ?>">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>"
						   ...
						   style="border-bottom: 3px solid #2b809b !important;    padding: 4px 13px">
							<!-- <i class="fa fa-home"></i> -->
							<img width="200" height="42" src="http://localhost/wordpress/wp-content/uploads/2021/02/cropped-servhub-logotrimmed-1.png" class="custom-logo" alt="" >
						</a>
					</div>
				<?php } ?>
